...
LOTTERY_ABI = [
    ...
    _fn("buyTicketsWithVoucher",
        ...
        mutability="payable"),
    _fn("enterFromWork",
        [{"name": "roundId", "type": "uint256"}, {"name": "participantId", "type": "bytes32"},
         {"name": "weightBps", "type": "uint16"},
         {"name": "expiry", "type": "uint64"}, {"name": "sig", "type": "bytes"}]),
    _fn("setPaidTicketsEnabled", [{"name": "on", "type": "bool"}]),
    _fn("paidTicketsEnabled", [], [{"name": "", "type": "bool"}], "view"),
    _fn("workSeated",
        [{"name": "roundId", "type": "uint256"}, {"name": "agent", "type": "address"}],
        [{"name": "", "type": "bool"}], "view"),
    _fn("participantSeated",
        [{"name": "roundId", "type": "uint256"}, {"name": "participantId", "type": "bytes32"}],
        [{"name": "", "type": "bool"}], "view"),
    _fn("setEntryWindow", [{"name": "w", "type": "uint64"}]),
    _fn("fund",
    ...
    _ev("WorkEntered",
        [{"name": "roundId", "type": "uint256", "indexed": True},
         {"name": "agent", "type": "address", "indexed": True},
         {"name": "participantId", "type": "bytes32", "indexed": True},
         {"name": "weight", "type": "uint256", "indexed": False}]),
    _ev("PaidTicketsSet",
