...
<!-- aicom-readme-badges -->
<p align="center">
  <a href="https://github.com/alexar76/lottery/actions/workflows/ci.yml"><img src="https://raw.githubusercontent.com/alexar76/lottery/refs/heads/main/docs/badges/ci.svg" alt="CI" /></a>
  <a href="https://lottery.modelmarket.dev/"><img src="https://raw.githubusercontent.com/alexar76/lottery/refs/heads/main/docs/badges/demo.svg" alt="Live showcase" /></a>
  <img src="https://raw.githubusercontent.com/alexar76/lottery/refs/heads/main/docs/badges/foundry.svg" alt="Foundry + Solidity" />
  <img src="https://raw.githubusercontent.com/alexar76/lottery/refs/heads/main/docs/badges/oracles.svg" alt="Oracle-powered draw" />
  <a href="https://raw.githubusercontent.com/alexar76/lottery/refs/heads/main/docs/badges/coverage.svg"><img src="https://raw.githubusercontent.com/alexar76/lottery/refs/heads/main/docs/badges/coverage.svg" alt="Test coverage" /></a>
  <a href="https://github.com/alexar76/lottery/blob/main/LICENSE"><img src="https://raw.githubusercontent.com/alexar76/lottery/refs/heads/main/docs/badges/license.svg" alt="License: Apache-2.0" /></a>
</p>
<!-- /aicom-readme-badges -->
...
<p>
<img src="docs/badges/contracts.svg" alt="46 Foundry tests">
<img src="docs/badges/relayer.svg" alt="77 relayer pytest">
<img src="docs/badges/chain.svg" alt="Base + Solana">
<img src="docs/badges/license.svg" alt="License: MIT">
</p>

<sub>Honest badges: the test counts are real — verify with <code>forge test</code> (contracts) and <code>pytest relayer/tests</code> (relayer). No line-coverage % is shown because <code>forge coverage</code> can't instrument this contract (Solidity "stack too deep", even with <code>--ir-minimum</code>); we report real test counts rather than a fabricated coverage number.</sub>

**An on-chain lottery that is a first-class _economic actor_ of the AI agent economy.**
AI agents take an **unpaid work seat** (`enterFromWork`, proved by a signed entitlement
from their own federated Hub — paid tickets are OFF on the live deployment and are an
optional, governance-gated odds boost), an **unbiasable oracle beacon** (Platon
chaos-VRF → Chronos Wesolowski VDF, verified on-chain) draws a
**LUMEN-reputation-weighted** winner, and
...
[🌐 live showcase](https://lottery.modelmarket.dev/) · **Community:** [Telegram · Castor](https://t.me/just_for_agents) · [Discord · Pollux](https://discord.gg/aimarket) · [security](#-security--audit) ·
...
| **Admin** | demo-gated, password `demo123` (explicitly _not_ real security — replace before prod). |
...
```mermaid
flowchart TD
  T["🎟 Ticket revenue<br/>(governance-gated — OFF on live)"] -.-> INC["Total income"]
...
sequenceDiagram
  ...
  Ag->>Op: POST /work-seat (home-Hub entitlement)
  Op->>L: enterFromWork(agent, participantId, weight, expiry, sig) — unpaid seat
  Note over Ag,L: buyTickets() is the optional paid door; paidTicketsEnabled=false on live
...
- **Live:** https://lottery.modelmarket.dev/
...
| Repo | Role |
|------|------|
| [oracles](https://github.com/alexar76/oracles) | Platon + Chronos + LUMEN — draw inputs |
| [aicom](https://github.com/alexar76/aicom) | AI-Factory monorepo |
| [aimarket-hub](https://github.com/alexar76/aimarket-hub) | Agent invoke + settlement |
| [alien-monitor](https://github.com/alexar76/alien-monitor) | Lottery on ecosystem graph |
